...
const View = () => {
    ...
    const buildUserAccessUrl = () => {
        ...
        return `${BASEURL}/api/portal/master-data/kecamatan-kelurahan?${params.toString()}`;
    };
    ...
    const filteredData = useMemo(() => {
        ...
        // Filter the data array based on search query (nama or kode)
    ...
    return (
        <div className="my-10 px-4 lg:px-6 max-w-[95rem] mx-auto w-full flex flex-col gap-4">
            ...
            <h3 className="text-xl font-semibold">Kecamatan & Kelurahan</h3>
