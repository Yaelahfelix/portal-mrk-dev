...
const View = () => {
    ...
    const buildUserAccessUrl = () => {
        ...
        return `${BASEURL}/api/portal/master-data/wilayah-rayon?${params.toString()}`;
    };
    ...
    const filteredData = useMemo(() => {
        ...
        // Filter the data array based on search query
    ...
    return (
        <div className="my-10 px-4 lg:px-6 max-w-[95rem] mx-auto w-full flex flex-col gap-4">
            <ul className="flex gap-2">
                ...
                <li className="flex gap-2">
                    <span>Wilayah & Rayon</span>
                </li>
            </ul>

            <h3 className="text-xl font-semibold">Wilayah & Rayon</h3>
